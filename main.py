...
def main():
    ...
    def show_user_details() -> None:
        ...
        map_widget.set_zoom(users[i].coords[0], users[i].coords[1])
    ...
    label_szczegoly_obiektu = Label(ramka_szczegoly_obiektu, text='Szczegoły obiektu: ')
